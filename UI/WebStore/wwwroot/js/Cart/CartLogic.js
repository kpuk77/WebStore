Cart = {
    ...
    initEvents: function () {
        ...
        $(".cartService_quantity_up").click(Cart.incrementProduct);
        $(".cartService_quantity_down").click(Cart.decrementProduct);
        $(".cartService_quantity_delete").click(Cart.removeProduct);
    },
    ...
    incrementProduct: function (event) {
        event.preventDefault();
        ...
        $.get(Cart._properties.addToCartLink + "/" + id)
            ...
            .fail(function () { console.log("increment fail"); });
    },

    decrementProduct: function (event) {
        event.preventDefault();
        ...
        $.get(Cart._properties.decrementCartLink + "/" + id)
            .done(function () {
                const count = parseInt($(".cart_quantity_input", tr).val());
                if (count > 1) {
                    $(".cart_quantity_input", tr).val(count - 1);
            ...
            .fail(function () { console.log("decrementProduct fail"); });
    },
    ...
    removeProduct: function (event) {
        ...
        $.get(Cart._properties.removeCartLink + "/" + id)
            .done(function () {
                tr.remove();
                Cart.refreshTotalPrice();
                Cart.refreshCartView();
